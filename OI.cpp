...
#include "Commands/RunGatherReverse.h"
...
// This is just a dummy UI to test the robot.
	...
	button5->WhileHeld(new RunGatherReverse());
	button4 = new JoystickButton(techController, 4);
	button4->WhileHeld(new RunGather());
	button3 = new JoystickButton(techController, 3);
	button3->WhenPressed(new ToggleShooterDeploy());
	...
	SmartDashboard::PutNumber("LeftRightAdjust", 0.00);
	...
	SmartDashboard::PutNumber("leftEncoder", 0.0);
	SmartDashboard::PutNumber("rightEncoder", 0.0);
	SmartDashboard::PutNumber("facing", 0.0);
