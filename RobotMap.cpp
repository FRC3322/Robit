...
DoubleSolenoid* RobotMap::drivetrainLeftShifter = NULL;
Encoder* RobotMap::drivetrainLeftEncoder = NULL;
DoubleSolenoid* RobotMap::drivetrainRightShifter = NULL;
Encoder* RobotMap::drivetrainRightEncoder = NULL;
Servo* RobotMap::climberSafetyMotor = NULL;
DoubleSolenoid* RobotMap::climberLeftClaw = NULL;
DoubleSolenoid* RobotMap::climberRightClaw = NULL;
...
void RobotMap::init() {
	...
	climberLeftClaw = new DoubleSolenoid(1, 5, 6);      
	
	
	climberRightClaw = new DoubleSolenoid(1, 7, 8);      
	...
	shooterDeploy = new DoubleSolenoid(2, 3, 4);      
	
	
	gathererMotor = new CANJaguar(8);
	
	
	gathererDeploy = new DoubleSolenoid(2, 1, 2);      
