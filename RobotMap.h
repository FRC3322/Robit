...
public:
	...
	static DoubleSolenoid* drivetrainLeftShifter;
	static Encoder* drivetrainLeftEncoder;
	static DoubleSolenoid* drivetrainRightShifter;
	static Encoder* drivetrainRightEncoder;
	static Servo* climberSafetyMotor;
	static DoubleSolenoid* climberLeftClaw;
	static DoubleSolenoid* climberRightClaw;
