...
// This is just a dummy UI to test the robot.
	...
	shooterbutton = new JoystickButton(driveStick, 7);
	...
	SmartDashboard::PutData("Deploy Shooter", new DeployShooter());
	SmartDashboard::PutData("Retract Shooter", new RetractShooter());
